...
<html>
    ...
    <body style="background-color: #1c1c1c; color: white; font-style: italic;">

        <%@include file="templates/header.jsp"%>

        <nav class="navbar navbar-light bg-light">
            <a class="img-fluid mx-auto navbar-brand">
                <img src="imagenes/banner.jpg" style="width: 80%; height: auto;" class="d-inline-block align-top" alt="banner">
            </a>
        </nav>
        <div style="font-family: 'Archivo Black';" class="container-fluid">
            <div class="row max-width">
                    ...
                    <div class="card card-body">
                        <form action="svCaninos" method="POST" enctype="multipart/form-data">
                            <div class="mb-3 text-center">
                                <label for="nombre" class="form-label" style="color: black; font-family: 'Courier New', Courier, monospace;"><b>Nombre del Perro</b></label>
                                <input type="text" name="nombre" class="form-control" id="nombre" placeholder="Ingresar el Nombre" required>
                            </div>
                            <div class="mb-3 text-center">
                                <label for="raza" class="form-label" style="color: black; font-family: 'Courier New', Courier, monospace;"><b>Raza del Perro</b></label>
                                <input type="text" name="raza" class="form-control" id="raza" placeholder="Ingresar la Raza" required>
                            </div>
                            <div class="mb-3 text-center">
                                <label for="foto" class="form-label" style="color: black;font-family: 'Courier New', Courier, monospace;"><b>Foto del Perro</b></label>
                            ...
                            <div class="mb-3 text-center">
                                <label for="puntos" class="form-label" style="color: black;font-family: 'Courier New', Courier, monospace;"><b>Puntos del Perro</b></label>
                                <select class="form-select" name="puntos" required>
                                    <option value="" disabled selected>Seleccione puntos de su perro...</option>
                            ...
                            <div class="mb-3 text-center">
                                <label for="edad" class="form-label" style="color: black;font-family: 'Courier New', Courier, monospace;"><b>Edad del Perro</b></label>
                                <input type="text" name="edad" class="form-control" id="edad" placeholder="Ingresar la Edad" required>
                            </div>
                ...
                <div class="col-md-7">
                    <table style="font-family: 'Courier New', Courier, monospace;" class="table  table-bordered table-light">
                        ...
                        <div class="navbar-nav">
                            <div class="input-group">
                                <input type="text" class="form-control" id="nombrePerroABuscar" placeholder="Buscar Nombre de Perro segun como se registro">
